...
// Versión: 2.0 - Guardado Corregido
// Corrige la URL de la API y el endpoint para asegurar que todos los datos del perfil se guarden correctamente.

import { useState, useEffect, useRef } from 'react';
import './App.css';

// [CORREGIDO] Se usa la variable de entorno correcta.
...
      const idToken = await user.getIdToken();
      // [CORREGIDO] Se usa el endpoint correcto con /api/
