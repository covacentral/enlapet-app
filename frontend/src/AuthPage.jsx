...
// --- DATOS CURIOSOS (Sin cambios) ---
const loadingFacts = ["¿Sabías que Laika fue el primer ser vivo en orbitar la Tierra?", "Hachiko, un perro Akita, esperó a su dueño por más de 9 años tras su muerte.", "Buscando en los archivos de mascotas famosas...", "Cher Ami, una paloma mensajera, salvó a casi 200 soldados en la I Guerra Mundial.", "Ajustando los collares del tiempo...", "Balto, un husky, lideró una expedición para llevar medicinas a un pueblo de Alaska.", "Pulimos tu placa con la historia de las mascotas..."];
...
function AuthPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
        ...
        // Enviar el token a nuestro backend para verificar y crear/autenticar el usuario en Firestore
  ...
  const handleRegister = async (e) => {
    ...
    // ... (Lógica de mensajes de carga sin cambios)
    try {
  ...
  return (
    <>
    {/* Estilos para el nuevo diseño, puedes moverlos a tu archivo App.css */}
    <style>{`
        .auth-container {
            max-width: 400px;
            margin: 2rem auto;
